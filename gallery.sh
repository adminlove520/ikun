...
INPUT="$(pwd)/still"
OUTPUT="$(pwd)/../output"
SOURCE_IMGURL="https://wsrv.nl/?url=https://raw.githubusercontent.com/adminlove520/ikun/master/still/"   ##"$INPUT/"   ## must end with "/"
VIEW_IMGURL="https://wsrv.nl/?url=https://raw.githubusercontent.com/adminlove520/ikun/gallery/"  ## must end with "/"
MY_INDEX_HTML_FILE="index.html"
MY_TITLE="IKUN 表情包大全 - 坤图大全"
MY_FOOTER='本页面自动生成于'
CNAME="ikun.hopeless9.top"
	...
	<div class="navbar navbar-dark bg-dark shadow-sm">
		<div class="container">
			<a href="../index.html" class="navbar-brand">
				...
				<a href="https://github.com/adminlove520/ikun" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '在 GitHub 上查看本项目'}">
                   <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 36 36" enable-background="new 0 0 36 36" xml:space="preserve" class="mdui-icon" style="width: 24px;height:24px;">
                      <path fill-rule="evenodd" clip-rule="evenodd" fill="#ffffff" d="M18,1.4C9,1.4,1.7,8.7,1.7,17.7c0,7.2,4.7,13.3,11.1,15.5
  c0.8,0.1,1.1-0.4,1.1-0.8c0-0.4,0-1.4,0-2.8c-4.5,1-5.5-2.2-5.5-2.2c-0.7-1.9-1.8-2.4-1.8-2.4c-1.5-1,0.1-1,0.1-1
  c1.6,0.1,2.5,1.7,2.5,1.7c1.5,2.5,3.8,1.8,4.7,1.4c0.1-1.1,0.6-1.8,1-2.2c-3.6-0.4-7.4-1.8-7.4-8.1c0-1.8,0.6-3.2,1.7-4.4
